...
--- Before Day-2 ---
I already knew first four of checklist.
--- 
...
- [x] I understand pipes (`|`) and redirection (`>`, `>>`, `2>`) and can chain commandsB
...
--- After Day-2 ---
I learned more depth of chain commands.
---

--- Feedback (Suggestions for the TDS Team) ---
Good checklist that was covered.
---
