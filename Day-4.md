...
--- Before Day-4 ---
I already knew http methods, status codes, devtools.
--- 
...
--- After Day-4 ---
API testing is been done via both swagger and sometimes postman as well.
---

--- Feedback (Suggestions for the TDS Team) ---
Devtools could be more comprehensive with manipulations as well. But for a bootcamp from scratch, it is good.
---
